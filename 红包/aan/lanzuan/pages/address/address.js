...
Page({
  ...
  */
  editAddress: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/addres/addres?id=' + e.currentTarget.dataset.id + '&cartId=' + cartId + '&pinkId=' + pinkId + '&couponId=' + couponId
    })
  },
  /**
   * 删除地址
  ...
  */
  addAddress: function () {
    ...
    this.setData({ cartId: '', pinkId: '', couponId: '' })
    wx.navigateTo({
      url: '/pages/addres/addres?cartId=' + cartId + '&pinkId=' + pinkId + '&couponId=' + couponId
    })
  },
  goOrder: function (e) {
