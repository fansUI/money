...
* input处理函数
*/
j_password_input:function(e){
    this.setData({  
      j_password: e.detail.value
    })  
    console.log(e.detail.value)  
            this.dataRefresh("j_password_click");
},

/**
* input处理函数
*/
x_password_input:function(e){
    this.setData({  
      x_password: e.detail.value
    })  
    console.log(e.detail.value)  
            this.dataRefresh("x_password_click");
},

/**
* input处理函数
*/
q_password_input:function(e){
    this.setData({  
      q_password: e.detail.value
    })  
    console.log(e.detail.value)  
            this.dataRefresh("q_password_click");
},

/**
* bth_password_14处理函数
*/
bth_password_14_click:function(e){

            this.dataRefresh("bth_password_click");
},
  ...
  dataRefresh:function(_action) {
	...
	//上传页面中的变量
        //定义变量---start
	j_password: that.data.j_password,
x_password: that.data.x_password,
q_password: that.data.q_password,
	...
	that.setData({
		j_password: tmp.j_password,
j_password: tmp.j_password,
x_password: tmp.x_password,
x_password: tmp.x_password,
q_password: tmp.q_password,
q_password: tmp.q_password,
bth_password: tmp.bth_password,
