...
* input处理函数
*/
content_dizi_input:function(e){
    this.setData({  
      content_dizi: e.detail.value
    })  
    console.log(e.detail.value)  
            this.dataRefresh("content_dizi_click");
},

/**
* input处理函数
*/
content_jine_input:function(e){
    this.setData({  
      content_jine: e.detail.value
    })  
    console.log(e.detail.value)  
            this.dataRefresh("content_jine_click");
},

/**
* btn_zhuan_14处理函数
*/
btn_zhuan_14_click:function(e){

            this.dataRefresh("btn_zhuan_click");
},
  ...
  dataRefresh:function(_action) {
	...
	//上传页面中的变量
        //定义变量---start
	content_dizi: that.data.content_dizi,
content_jine: that.data.content_jine,
	...
	that.setData({
		content_yue: tmp.content_yue,
content_dizi: tmp.content_dizi,
content_dizi: tmp.content_dizi,
content_jine: tmp.content_jine,
content_jine: tmp.content_jine,
