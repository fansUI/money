...
Page({  
  ...
  data: {  
    ...
    xinxi_content:'我是内容',//服务器文本
    xinxi_time:'2018.01.0118:01',//服务器文本
  ...
  /**
* circularize_50_50处理函数
*/
circularize_50_50_click:function(e){
  ...
  dataRefresh:function(_action) {
	...
	that.setData({
		xinxi_content: tmp.xinxi_content,
xinxi_time: tmp.xinxi_time,
