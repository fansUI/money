...
Page({  
  ...
  data: {  
    list_4: [
      {
        id:1,
        img:'http://wx.ymznkf.com/project/8576/tabbarDemo/newsteends/images/newsteends_img_6.jpg',
        laiy:'null',
        till:'null',
        time:'18:02',
    ...
    img:'http://wx.ymznkf.com/project/8576/tabbarDemo/newsteends/images/newsteends_img_6.jpg',//服务器文本
    laiy:'null',//服务器文本
    till:'null',//服务器文本
    time:'18:02',//服务器文本
...
* newsteends_3_3处理函数
*/
newsteends_3_3_click:function(e){
...
* newsteends_5_5处理函数
*/
newsteends_5_5_click:function(e){

   wx.navigateTo({
   url:'/pages/newspage/newspage?id='+this.data.id+''
  })
},
