...
Page({  
  ...
  /**
* merchantmovest_2_2处理函数
* 数据绑定  data-index="{{index}}" 
* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.data.list_cata_list[index];
*/
merchantmovest_2_2_click:function(e){

},

/**
* merchantmovest_3_3处理函数
* 数据绑定  data-index="{{index}}" 
* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.data.list_cata_list[index];
*/
merchantmovest_3_3_click:function(e){

},

/**
* merchantmovest_8_8处理函数
* 数据绑定  data-index="{{index}}" 
* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.data.list_cata_list[index];
*/
merchantmovest_8_8_click:function(e){

   wx.navigateTo({
   url:'/pages/mestore/mestore'
  })
},
